...
baxodir.configure(background='#010d1d')
baxodir.geometry("930x700")
baxodir.title("Transport muammosi")
heading = Label(text = "Least Cost Method - Eng kam xarajat usuli", bg="#154c79", fg = "white", width = "500", height = "1", font=('Arial 24'))
heading.pack()
...
canvas1 = Canvas(frame1, bg="#010d1d")
...
frame2 = Frame(baxodir, bd=1, relief="raised", bg="#010d1d")
frame2.pack(fill=BOTH, side=LEFT)
canvas2 = Canvas(frame2, bg="#010d1d")
...
frame3 = Frame(baxodir, bd=1, relief="raised", bg="#010d1d")
frame3.pack(fill=BOTH, side=LEFT)
canvas3 = Canvas(frame3, bg="#010d1d")
...
def a_input_function1():
    ...
    a_label = Label(birlashuvchi, text=f"Supply{l1+1}")
...
def a_input_function3():
    ...
    for i in range(len(a)):
        ...
        for j in range(len(b)):
            l_1 = Label(birlashuvchi3, text=f"Matrix[{i}][{j}]")
            l_1.pack()
...
def ekrangaLCM():
    ...
    for i in list3:
        ...
        DDD.append(col2)
    LCM(DDD,bbb,aaa)
    text2 = tk.Text(baxodir, width=100, height=100, fg = "white", bg="#010d1d", font=('Arial 30'),  pady=20)
    text2.pack()
...
add_label1 = tk.Label(birlashuvchi, text = "Supply qo'shish", font=('Arial 20'))
add_label1.pack(side=tk.TOP)
add_input1 = tk.Button(birlashuvchi, text="+", activeforeground = "green", width=10, font=('Arial 20'), command=a_input_function1)
add_input1.pack(side=tk.TOP)


add_label2 = tk.Label(birlashuvchi2, text = "Demand qo'shish", font=('Arial 20'))
add_label2.pack()
add_input2 = tk.Button(birlashuvchi2, text="+", activeforeground = "green", width=10, font=('Arial 20'), command=a_input_function2)
add_input2.pack(side=tk.TOP)


add_label3 = tk.Label(birlashuvchi3, text = "Matrix qo'shish", font=('Arial 20'))
add_label3.pack()
add_input3 = tk.Button(birlashuvchi3, text="+", activeforeground = "green", width=10, font=('Arial 20'), command=a_input_function3)
